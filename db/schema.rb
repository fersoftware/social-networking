...
ActiveRecord::Schema.define(version: 2021_06_14_004303) do
  ...
  create_table "subcriptions", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["followed_by_id"], name: "index_subcriptions_on_followed_by_id"
    t.index ["followed_id"], name: "index_subcriptions_on_followed_id"
  end
  ...
  add_foreign_key "subcriptions", "users", column: "followed_by_id"
  add_foreign_key "subcriptions", "users", column: "followed_id"
